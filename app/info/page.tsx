    ...
    <section className="grid infoPageGrid">
      ...
      <article className="card infoLicenseCard">
        ...
        <p className="infoDbsThanks">
          We give thanks to God for the global Scripture resources made
          available through the{" "}
          <a href="https://dbs.org/" target="_blank" rel="noreferrer">
            Digital Bible Society
          </a>
          . Their multilingual catalog helps ShepherdStudy serve readers across
          languages and communities far beyond the reach of our small local
          Scripture library.
        </p>
        <p>
          We are deeply grateful to the Digital Bible Society and to the
          translators, ministries, publishers, and supporters whose faithful
          work helps make these editions available around the world. Most DBS
          editions in ShepherdStudy are retrieved from their service only when
          needed and cached carefully; the full DBS library is not copied into
          our database.
        </p>
        <p>
